...
import { DiJavascript1, DiReact, DiMongodb, DiSass, DiDjango, DiPostgresql, DiSymfony, DiLaravel, DiPython, DiDocker, DiWordpress} from "react-icons/di";
...
export const SkillsData = [
  {
    Advance: [
      ...
      {
        name: "Django",
        icon: <DiDjango className="md:text-4xl text-2xl" color="#4caf50" />
      },
      {
        name: "Python",
        icon: <DiPython className="md:text-4xl text-2xl" color="#4B8BBE" />
      },
      {
        name: "Docker",
        icon: <DiDocker className="md:text-4xl text-2xl" color="#29b6f6" />
      },
      {
        name: "Laravel",
        icon: <DiLaravel className="md:text-4xl text-2xl" color="#F05340" />
      },
      {
        name: "Wordpress",
        icon: <DiWordpress className="md:text-4xl text-2xl" color="#673ab7" />,
      },     
    ],
    Good: [
      {
      ...
      {
        name: "PostgreSQL",
        icon: <DiPostgresql className="md:text-4xl text-2xl" color="#4caf50" />,
      },
      {
        name: "Symfony",
        icon: <DiSymfony className="md:text-4xl text-2xl" color="#ffcd33" />
      },
