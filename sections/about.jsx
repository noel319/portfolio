        ...
        <div className='pb-[30px] px-[20px] md:px-[100px] lg:px-[200px] md:flex gap-[50px]'>
          ...
          >
            ...
            <div className='mt-5 justify-evenly text-justify'>
              ...
              I specialize in building scalable, user-centric 
                solutions using React, PHP, Node.js, and 
                modern testing frameworks. My expertise in 
                bridging frontend innovation (Next.js, Vue.js, Wordpress, React.js, GraphQL) 
                with backend robustness (Laravel, Django, Node.js, Redis, FastAPI,  REST APIs, AWS) 
                ensures clean, maintainable code. I thrive in 
                Agile environments, prioritize automated 
                testing, and excel at translating complex tech 
                concepts for non-technical stakeholders. If you 
                need a developer who can own projects end-to
                end, optimize workflows, and deliver high
                performance features on time, let’s connect!
              </p>
            </div>
          </div>
        </div>
